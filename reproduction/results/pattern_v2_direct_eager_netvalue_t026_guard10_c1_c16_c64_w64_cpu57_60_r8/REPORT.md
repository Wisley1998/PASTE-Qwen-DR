...
|---|---:|---:|---:|---:|---:|---:|:---:|---:|---:|---:|---:|:---:|
| observed_nested_oof | 1 | 1 | 0.260 | +0.005 | +0.005 | +0.082 | inconclusive | -0.0% | 0.4% | 33.3% | 1.013x | inconclusive |
| observed_nested_oof | 16 | 1 | 0.260 | +0.079 | +0.079 | -0.034 | inconclusive | -0.2% | 0.2% | 20.0% | 1.011x | inconclusive |
| observed_nested_oof | 64 | 1 | 0.260 | -0.677 | -0.677 | +0.677 | improvement | +0.4% | 0.0% | 0.0% | 1.000x | inconclusive |
| all_wrong_counterfactual | 1 | 1 | 0.260 | +0.123 | +0.123 | -0.123 | regression | -0.1% | 0.0% | 0.0% | 1.013x | inconclusive |
| all_wrong_counterfactual | 16 | 1 | 0.260 | +0.213 | +0.213 | -0.213 | regression | -0.3% | 0.0% | 0.0% | 1.011x | inconclusive |
| all_wrong_counterfactual | 64 | 1 | 0.260 | -0.322 | -0.322 | +0.322 | inconclusive | +0.3% | 0.0% | 0.0% | 1.000x | inconclusive |
