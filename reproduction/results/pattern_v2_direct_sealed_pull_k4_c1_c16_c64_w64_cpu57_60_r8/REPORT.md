...
|---|---:|---:|---:|---:|---:|---:|:---:|---:|---:|---:|---:|:---:|
| observed_nested_oof | 1 | 4 | 0.000 | -0.044 | -0.044 | +4.263 | improvement | +0.2% | 20.5% | 15.4% | 2.334x | pass |
| observed_nested_oof | 16 | 4 | 0.000 | +0.279 | +0.279 | +1.315 | improvement | -0.1% | 7.6% | 18.7% | 1.407x | regression |
| observed_nested_oof | 64 | 4 | 0.000 | -0.084 | -0.084 | +0.084 | inconclusive | +0.2% | 0.0% | 0.0% | 1.000x | inconclusive |
| all_wrong_counterfactual | 1 | 4 | 0.000 | +0.033 | +0.033 | -0.033 | inconclusive | +0.1% | 0.0% | 0.0% | 2.324x | inconclusive |
| all_wrong_counterfactual | 16 | 4 | 0.000 | +0.183 | +0.183 | -0.183 | inconclusive | -0.0% | 0.0% | 0.0% | 1.405x | inconclusive |
| all_wrong_counterfactual | 64 | 4 | 0.000 | +0.568 | +0.568 | -0.568 | inconclusive | +0.1% | 0.0% | 0.0% | 1.000x | inconclusive |
