...
|---:|---:|---:|:---:|---:|:---:|:---:|:---:|
| 1 | 8 | -0.0062 | [-0.1223, +0.1100] | +0.026% | [+0.015%, +0.038%] | inconclusive | pass |
| 16 | 8 | +0.3761 | [+0.0530, +0.6992] | +0.182% | [+0.098%, +0.266%] | inconclusive | pass |
| 64 | 8 | -0.1808 | [-0.8255, +0.4639] | -0.033% | [-0.187%, +0.121%] | inconclusive | pass |
...
- Treatment uses a forked process sidecar, K=4 by default, finite leases, lazy result bridge, topology-aware dedicated CPU placement, and SCHED_IDLE. All future batches are handed off in one bounded packet before the timed origin; `timed_parent_submit_packets=0` is enforced. No exact claims, result packets, terminal packets, or parent tombstone packets are permitted before the safety gate.
